            ...
            <TabsContent value="vrfs" className="pt-4 space-y-3">
              <div className="flex items-center justify-between">
                <div className="text-sm text-muted-foreground">
                  Manage VRFs for this organization. These VRFs can be assigned to any router in the fleet.
                </div>
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead className="w-44">ROUTE DISTINGUISHER</TableHead>
                  ...
                  <TableBody>
                    {vrfs.map((v) => (
                      <TableRow key={v.id}>
                        ...
                        <TableCell className="font-mono">{v.rd ?? "-"}</TableCell>
